...
public class KitsuneController : MonoBehaviour, IInvisibilityProvider
{
    ...
    [SerializeField] private float spiritRecoveryInterval = 0.2f;
    [SerializeField] private float spiritRecoveryAmount = 2.5f;
    ...
    void RecuperarEspirituInvisible()
    {
        ...
        nextSpiritRecoveryTime = Time.time + 0.2f;

        kitsuneSpirit.AddSpirit(2.5f);

        Debug.Log("🔮 [INVISIBILIDAD] Absorbiendo ráfagas de energía: "
